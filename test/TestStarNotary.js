...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let tokenId = 9;
    let instance = await StarNotary.deployed();
    const starInfo = 'Test star info star'
    await instance.createStar(starInfo, tokenId, {from: accounts[0]});

    assert.equal(await instance.lookUptokenIdToStarInfo(tokenId), starInfo);
});