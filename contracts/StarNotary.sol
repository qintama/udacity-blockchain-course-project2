...
contract StarNotary is ERC721, ERC721Metadata {
    ...
    constructor() public ERC721Metadata("StarNotary Token", "SNT") {}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == user1 || msg.sender == user2, "Not owner of either stars");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "Not owner of the star");
